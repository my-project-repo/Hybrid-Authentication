...
const refreshTokenHandler = async (req, res) => {
    try {
        ...
        const isValidRefreshToken = await argon2.verify(session.refreshTokenHash, refreshToken);
...
// ─── Exports ─────────────────────────────────────────────────────────────────
export { registerUser, loginUser, getUserProfile, refreshTokenHandler, logoutUser, };
